...
function LoadSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfolder("FloraSoftworks") then
				makefolder("FloraSoftworks")
			end
			if not isfolder("FloraSoftworks/Blox Fruits/") then
				makefolder("FloraSoftworks/Blox Fruits/")
			end
			if not isfile("FloraSoftworks/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				writefile("FloraSoftworks/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
			else
				local Decode = game:GetService("HttpService"):JSONDecode(readfile("FloraSoftworks/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfile("FloraSoftworks/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				...
				writefile("FloraSoftworks/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
			end
		else
			return warn("Status : Undetected Executor")
		end
...
local Win = library:Evil("FloraBF | ","",_G.Logo )
